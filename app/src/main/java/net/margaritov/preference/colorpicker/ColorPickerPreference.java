...
public class ColorPickerPreference
    ...
    private boolean mHexValueEnabled = true; // PBCS
    ...
    @Override // PBCS
    public CharSequence getSummary() { // PBCS
        return convertToRGB(mValue).toUpperCase(Locale.getDefault()); // PBCS
    } // PBCS
    ...
    public void onColorChanged(int color) {
        ...
        mValue = color;
        setPreviewColor();
        setSummary(convertToRGB(mValue)); //PBCS
        try {
